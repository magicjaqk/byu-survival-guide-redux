                ...
                <div className="col-lg-6">
                    ...
                    <div className="page-content topic-content mt-4 mx-2">
                        ...
                        <ol className="list-group">
                            <li className="list-group-item bg-info text-center text-white">
                                <h3><b>Support and Harm Prevention Resources</b></h3>
                            </li>
                            <li className="list-group-item">
                                <h4 style={{'text-decoration':'underline'}}><b>National Suicide Prevention Lifeline:</b></h4>
                                <h5><b>English:</b> <a href="tel:(800) 273-8255">1 (800) 273-8255</a></h5>
                                <h5><b>Espanol:</b> <a href="tel:(800) 784-2432">1 (800) SUICIDA</a></h5>
...
const SupportListing = (props) => {
    ...
    return (
        <li className="list-group-item">
            <h4 style={{'text-decoration':'underline'}}><b>{`${title}`}:</b></h4>
