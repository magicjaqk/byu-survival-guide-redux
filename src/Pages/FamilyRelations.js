                ...
                <div className="col-lg-6">
                    <div id="title-colorbox" className="bg-primary">
                        <h1 className="m-auto text-center text-white p-md-5 py-5" id="title">
                            Discussing Your Faith Crisis With Family
                        </h1>
                    </div>
                    <div className="page-content topic-content mt-4 mx-2">
                        ...
                        <p>
                            If you have decided to stay at BYU for schooling and you have determined your family will not attempt to sabotage your educational goals in any way, you may want to discuss this with family. Help them understand why you want to stay at BYU. It may be helpful to let them believe that by staying at BYU you may be pulled back into the church. Likewise, if you are transferring out of BYU, you should also express this to family. <br/>
                            <br/>
                            Overall, family interactions can be some of the most complex parts of navigating a faith crisis/transition. Take care to approach the situation with the finesse it requires. Poor communication or mediation can set the trajectory for years to come if not resolved early on. I don’t want to make the situation more stressful than it is, but I also know more than one person who have inadvertently created situations that they could have avoided if given proper attention early on. Good luck and have some moral support as you confront this issue: <br/>
                        </p>
                        <img className="img-fluid" src={require("../Images/pikachu.gif")} alt="[pikachu good luck gif]"/>
                    </div>
                </div>
                <div className="col-lg-3" />
            </div>
